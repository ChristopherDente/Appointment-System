...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2026 at 05:36 AM
...
CREATE TABLE `tbclinicdays` (
  `PK_tbclinicdays` int(11) NOT NULL,
...
INSERT INTO `tbclinicdays` (`PK_tbclinicdays`, `dayname`) VALUES
(1, 'Monday'),
(2, 'Tuesday'),
(3, 'Wednesday'),
(4, 'Thursday'),
...
(4, 'ejian', '$2y$10$dzR3MhxYSJ3mTnRCrn64Q.Rkqi2.dz0VdOdO34fN9LBaquabGZom.', 'Jian Laurence', 'Salvedea', 'Ebidag', NULL, 'jianlaurenceebidag@gmail.com', '#21 Luna St. New Banicain, Olongapo City', '09127339200', 1, NULL, NULL, 1, NULL, 1, 1, NULL, '2026-01-16 05:11:52', NULL);
...
ALTER TABLE `tbclinicdays`
  ADD PRIMARY KEY (`PK_tbclinicdays`);
...
--
ALTER TABLE `tbclinicdays`
  MODIFY `PK_tbclinicdays` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tblappointments`
--
ALTER TABLE `tblappointments`
  MODIFY `PK_tblappointments` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbldoctors`
  MODIFY `PK_tbldoctors` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbldoctorschedule`
--
ALTER TABLE `tbldoctorschedule`
  MODIFY `PK_tbldoctorschedule` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tblpatient`
  MODIFY `PK_tblpatient` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tblrole`
--
ALTER TABLE `tblrole`
  MODIFY `PK_tblRole` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tblservices`
--
ALTER TABLE `tblservices`
  MODIFY `PK_tblservices` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbluser`
--
ALTER TABLE `tbluser`
  MODIFY `PK_tbluser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbldoctorschedule`
  ADD CONSTRAINT `tbldoctorschedule_ibfk_1` FOREIGN KEY (`FK_clinicdays`) REFERENCES `tbclinicdays` (`PK_tbclinicdays`),
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `cleanup_login_attempts` ON SCHEDULE EVERY 1 HOUR STARTS '2026-01-16 12:05:08' ON COMPLETION NOT PRESERVE ENABLE DO DELETE FROM `login_attempts` WHERE `last_attempt` < DATE_SUB(NOW(), INTERVAL 24 HOUR)$$
