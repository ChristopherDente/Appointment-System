                ...
                <div class="card-doctor p-4">
                    ...
                    <form id="bookingForm" method="POST" action="save-appointment.php">
                        ...
                        <div class="form-section active" id="step1">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="doctor-card" onclick="selectDepartment(this, 'General Medicine')">
                                ...
                                <div class="col-md-6">
                                    <div class="doctor-card" onclick="selectDepartment(this, 'Cardiology')">
                                ...
                                <div class="col-md-6">
                                    <div class="doctor-card" onclick="selectDepartment(this, 'Pediatrics')">
                                ...
                                <div class="col-md-6">
                                    <div class="doctor-card" onclick="selectDepartment(this, 'Orthopedics')">
                                ...
                                <div class="col-md-6">
                                    <div class="doctor-card" onclick="selectDepartment(this, 'Dermatology')">
                                ...
                                <div class="col-md-6">
                                    <div class="doctor-card" onclick="selectDepartment(this, 'Dentistry')">
