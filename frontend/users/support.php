...
if ($user_id) {
    // Get patient ID and user info
    $user_query = "SELECT u.fname, u.lname, u.email, p.PK_tblpatient 
                   FROM tbluser u
                   LEFT JOIN tblpatient p ON p.FK_tbluser = u.PK_tbluser
                   WHERE u.PK_tbluser = ?";
...
<head>
    <meta charset="UTF-8">
    <title>Help & Support - Online Appointment Booking System</title>
...
<body>
                ...
                <div class="contact-form">
                    ...
                    <form id="contactForm">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-doctor" id="submitBtn">
                                    <i class="bi bi-send"></i> <span id="btnText">Send Message</span>
                                </button>
                            </div>
                        </div>
                    </form>
    ...
    document.getElementById('contactForm').addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            alertDiv.innerHTML = `
                <i class="bi bi-${data.success ? 'check-circle' : 'exclamation-circle'} me-2"></i>
                ${data.message}
            `;
